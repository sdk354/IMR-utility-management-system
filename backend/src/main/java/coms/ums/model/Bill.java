...
public class Bill {
    ...
    // REMOVED: private boolean paid; (This column does not exist in your DB)
    ...
    public Long getBillID() { return id; }
    ...
    // UPDATED: Helper method to replace the old boolean logic
