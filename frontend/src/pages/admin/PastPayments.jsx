	...
	return (<div className="admin-page">
		<div className="admin-table-container">
			...
			<table className="admin-table">
				...
				<tbody>
				{loading ? (<tr>
					<td colSpan="5" style={{textAlign: 'center'}}>Loading payment history...</td>
				</tr>) : payments.length === 0 ? (<tr>
					<td colSpan="5" style={{textAlign: 'center'}}>No payment records found for this customer.
					</td>
				</tr>) : (payments.map((payment) => (<tr key={payment.id}>
