...
function AddEditCustomer() {
	...
	const [formData, setFormData] = useState({
		username: '', password: '', contactNo: '', email: '', street: '', streetNo: '', city: '', status: 'Active'
	});
	...
	const statusOptions = [{label: 'Active', value: 'Active', color: '#10b981'}, {
					...
					<div className="admin-form-grid">
						<div className="admin-form-group">
							...
							<input type="text" value={displayName} onChange={handleNameChange}
								   placeholder="e.g., James Snow" required/>
						...
						<div className="admin-form-group">
							...
							<input type="tel" name="contactNo" value={formData.contactNo} onChange={handleChange}
								   placeholder="e.g., 0763356273"/>
						</div>

						<div className="admin-form-group">
							<label>Email</label>
							<input type="email" name="email" value={formData.email} onChange={handleChange}
								   placeholder="e.g., jsnow@email.com" required/>
						</div>

						<div className="admin-form-group">
							<label>Street Number</label>
							<input type="text" name="streetNo" value={formData.streetNo} onChange={handleChange}
